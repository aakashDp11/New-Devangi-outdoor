...
              <Button 
                onClick={addCampaign} 
                className="bg-[black] text-white hover:bg-gray-800 transition-all duration-200 transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-md hover:shadow-lg mt-4"
              >
                + Add New Campaign
              </Button>
            </>
