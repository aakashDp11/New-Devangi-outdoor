...
//   return (
//     <div className="text-xs min-h-screen bg-gray-100  w-screen text-black flex flex-col lg:flex-row ">
//       <Navbar />
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setSpaceDetails(fetchedSpaces);
        const pipelineRes = await fetch(`http://localhost:3000/api/pipeline/campaign/${id}`);
