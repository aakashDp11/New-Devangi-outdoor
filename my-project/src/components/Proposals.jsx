...
const PaginationLink = ({ children, isActive = false, onClick }) => (
  <div className="flex gap-2 flex-wrap text-xs">
    ...
    <button
    onClick={onClick}
    className={`px-3 py-1 text-xs rounded ${isActive ? 'bg-black text-white' : 'bg-gray-200 hover:bg-gray-300'} transition`}
  >
    {children}
    </button>
    <button>
...
export default function ProposalsDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafb] h-screen w-screen bg-gray-50 text-black flex flex-col lg:flex-row overflow-hidden">
      <Navbar />
      ...
      <main className={`flex-1 h-full overflow-y-auto px-4 md:px-6 py-6 transition-all duration-300 ${isCollapsed ? 'lg:ml-24' : 'lg:ml-64'}`}>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
         <h2 className="text-2xl font-sans font-normal">Proposals</h2>
