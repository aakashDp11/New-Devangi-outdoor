...
            </Button>
          </div>
          <h1 className="text-2xl md:text-3xl font-bold text-[var(--color-text)] mb-6 animate-slideDown">Create New Space</h1>
          
...
            {step === "Basic" && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 transition-opacity duration-500 animate-fadeIn">
...
            {step === "Specifications" && (
              <Card className="transition-opacity duration-500 animate-fadeIn">
                <CardContent>
