...
//             <p className="text-xs text-gray-900">{invoiceNumber}</p>
//           </div>
//           {invoiceUrl && (
//   <div>
//     <label className="block text-xs font-medium text-gray-700">Uploaded Invoice File:</label>
...
export default function InvoiceForm({ campaignId, onConfirm,onClose }) {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 bg-white p-6 ">
      <h2 className="text-2xl font-semibold mb-4 text-gray-800 text-center">Invoice Details</h2>
      ...
      {isInvoiceSaved ? (
        <div className="space-y-4 text-xs text-gray-700">
          ...
          <div>
            <label className="block font-medium">Invoice Value:</label>
            <p>₹{invoiceValue}</p>
          </div>
        ...
        <button
  onClick={onClose}
  className="w-[50%] mt-4 mx-auto text-xs bg-gray-300 text-black py-2 rounded-xl hover:bg-gray-400 transition duration-200"
>
  Close
</button>
          </div>
