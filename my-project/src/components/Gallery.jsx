...
export default function Gallery() {
  ...
  }, [currentPage, search, navigate, sortConfig, addNotification]);
  ...
  const handleDownloadImages = async (item) => {
    ...
    if (promises.length > 0) {
      ...
      toast.success('All available artworks are being downloaded.');
    } else {
                ...
                bookings.map((item, index) => (
                  ...
                  >
                    <CardContent className="flex flex-col gap-4">
                      <div className="text-md font-semibold text-[var(--color-text)]">
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mt-2">
                        <div className="flex-1 flex flex-col gap-1">
                          <div className="text-xs text-[var(--color-muted)]">Client: {item.clientName || 'N/A'}</div>
                          <div className="text-xs text-[var(--color-muted)]">Brand: {item.brandDisplayName || 'N/A'}</div>
                        </div>
