...
//               const remainingUnits = space.unit - space.occupiedUnits - globallySelectedUnits +
//                 (campaign.selectedSpaces?.find(s => s.id === space.id)?.selectedUnits || 0);
...
//                   <td className="px-2 py-2">{space.unit}</td>
//                   <td className="px-2 py-2">
//                     {space.status === "Completely booked" || !canSelectUnits ? (
//                       <span className="text-gray-400 italic">N/A</span>
//                     ) : (
//                       <input
//                         type="number"
//                         min={1}
//                         max={remainingUnits}
//                         value={campaign.selectedSpaces?.find(s => s.id === space.id)?.selectedUnits || 1}
