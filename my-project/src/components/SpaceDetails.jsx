...
    >
      <div
        className="bg-gray-100 p-6 rounded-2xl shadow-lg w-80 text-[var(--color-text)] transform transition-all duration-300 scale-95 animate-scaleIn"
        onClick={(e) => e.stopPropagation()}
      >
        {children}
      </div>
...
          {/* Combined section for Images and Map Location */}
...
                  <div className="h-64 md:h-80 w-full rounded-2xl overflow-hidden border border-gray-200 shadow-sm aspect-square lg:h-auto">
                    <MapPreview
