...
import Report from "./components/Report.jsx"; // Ensure this component exists
...
// *** NEW INVOICING COMPONENTS IMPORTED ***
      ...
      <SidebarProvider>
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            ...
            {/* 🛑 FIX APPLIED HERE: Reverted /reports to use the generic Report component */}
            <Route path="/reports" element={<Report />} /> 
            {/* 🆕 ADDED: Specific route for the Invoice Reports page */}
            <Route path="/reports/invoices" element={<InvoiceReports />} />
            ...
            {/* 🆕 CONSOLIDATED INVOICING ROUTES (all under /misc-invoices) */}
            <Route path="/misc-invoices" element={<InvoiceList />} />
            <Route path="/misc-invoices/create" element={<InvoiceForm />} />
            <Route path="/misc-invoices/edit/:id" element={<InvoiceForm />} />
            <Route path="/misc-invoices/view/:id" element={<InvoiceView />} />
