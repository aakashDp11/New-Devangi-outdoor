...
    dueDate: '',
    // Initial state set to strings to match fetchInvoice output and allow editing
    lineItems: [
...
      setFormData({
        ...data,
        // ✅ FIX #1: Ensure numbers are converted to strings when loading from backend 
...
    // ✅ FIX #3: Handle 'description' field separately as it's a string
...
    // Store the value as a string directly from input to allow editing
    
    if (field === 'amount') {
...
        // Use parseFloat() to safely convert string state to numbers for calculation
...
                      <input
                        type="number"
                        // ✅ FIX: Use .toString() on value prop to enable smooth editing
