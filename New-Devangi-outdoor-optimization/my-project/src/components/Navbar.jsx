...
// import { getUnreadNotificationsCount } from '../services/notificationService'; // Original service call
import {
  FaHome, FaBoxOpen, FaCalendarCheck, FaFileAlt, FaUsers,
  FaChartBar, FaRupeeSign, FaImages, FaArrowLeft, FaArrowRight,
  FaShieldAlt, FaSignOutAlt, FaExclamationCircle, FaBell, FaReceipt // Import FaReceipt for Invoices
} from 'react-icons/fa';
...
    { label: 'Proposals', path: '/proposal-dashboard', icon: <FaFileAlt /> },
    ...
    { label: 'External Invoices', path: '/invoices', icon: <FaReceipt /> },
    // *************************************
